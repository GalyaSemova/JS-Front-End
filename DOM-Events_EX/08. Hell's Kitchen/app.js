...
//    function onClick () {
//       //iinput => arr of strings;
//       let textValue = document.querySelector('#inputs > textarea').value.split(', ');
//       const bestRestaurants = document.querySelector('#outputs > #bestRestaurant > p');
//       const bestWorkers = document.querySelector('#workers > p');
//       let averageSalary = Math.min();
//       let bestRestaurant = '';


//       for (const string of textValue) {
//          let sumOfSalaries = 0;
//          let currentAverageSalary = 0;
//          let currentName = '';debugger;

//          let restaurantName = string.split(" - ")[0];
//          let info = string.split(" - ")[1];
...
//                   let salary = Number(pair.split(' ')[1]);
...
//          currentAverageSalary = sumOfSalaries / infoPair.length;
...
//       bestRestaurants.textContent = `Name: ${bestRestaurant} Average Salary: ${averageSalary.toFixed(2)} Best Salary: {restaurant bestSalary}`
